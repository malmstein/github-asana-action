...
async function createIssueTask(client){
    ...
    const TASK_COMMENT = `Link to Issue: ${ISSUE.number}`;

    const task = await createTask(client, TASK_NAME, TASK_DESCRIPTION, ISSUE.html_url, ASANA_PROJECT_ID, ASANA_CUSTOM_FIELD_ID)
